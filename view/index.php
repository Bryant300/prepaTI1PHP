        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="specialty-card">
              <div class="specialty-content">
                ...
                <a href="department-details.php" class="specialty-link">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="department-highlight">
              ...
              <a href="department-details.php" class="highlight-cta">Learn More</a>
            </div>
            ...
            <div class="col-lg-6">
              <div class="content-wrapper" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="cta-wrapper">
                  <a href="appointment.php" class="primary-cta">
                    <span>Schedule Consultation</span>
                    <i class="bi bi-arrow-right"></i>
                  </a>
                  <a href="services.php" class="secondary-cta">
          ...
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="contact-actions" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="contact.php" class="contact-link">Find Location</a>
              </div>
            </div>
